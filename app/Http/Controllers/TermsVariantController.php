...
class TermsVariantController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if(\Auth::user()->can('manage product & service'))
        {
            ...
            $productServices = TermVariation::where('priority', '=', 0)->get();

            return view('termspecification.index', compact('productServices'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            $group = Term::where('created_by', '=', \Auth::user()->creatorId())->get()->pluck('name', 'id');
            $group->prepend('Select Term', '');
            return view('termspecification.create', compact('group'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create product & service'))
        {
            ...
            $productService                      = new TermVariation();
            $productService->details                = $request->details;
            $productService->term_id = $request->term_id;
