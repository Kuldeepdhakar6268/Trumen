...
///copy link
Route::get('quotation/pdf/download/{id}', [QuotationController::class, 'quotationPdf'])->name('quotation.pdf.download');
...
Route::get('jobcard/download/{id}', [QuotationController::class, 'jobcardPdf'])->name('jobcard.download');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/sales-crm-dashboard', [DashboardController::class, 'sales_dashboard_index'])->name('sales.crm.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/purchase-management-dashboard', [DashboardController::class, 'purchase_management_dashboard_index'])->name('purchase.management.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/production-dashboard', [DashboardController::class, 'production_dashboard_index'])->name('production.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/manufacturing-dashboard', [DashboardController::class, 'manufacturing_dashboard_index'])->name('manufacturing.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/disptch-dashboard', [DashboardController::class, 'disptch_dashboard_index'])->name('disptch.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/inventory-dashboard', [DashboardController::class, 'inventory_dashboard_index'])->name('inventory.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::resource('materialstock', MaterialStockController::class)->middleware(['auth', 'XSS']);
    Route::post('material/part', [MaterialStockController::class, 'part'])->name('material.part')->middleware(['auth', 'XSS']);
    ...
    Route::post('product-specification/getspecification', [ProductServiceCategoryController::class, 'getSpecification'])->name('productServiceCategory.getspecification')->middleware(['auth', 'XSS', 'revalidate']);
     ...
     Route::post('product-specification/getspecificationMaterials', [ProductServiceCategoryController::class, 'getSpecificationMaterials'])->name('productServiceCategory.getspecificationMaterials')->middleware(['auth', 'XSS', 'revalidate']);
      Route::post('product-specification/getspecificationGland', [ProductServiceCategoryController::class, 'getSpecificationGland'])->name('productServiceCategory.getspecificationGland')->middleware(['auth', 'XSS', 'revalidate']);
      Route::post('product-specification/getspecificationPrice', [ProductServiceCategoryController::class, 'getSpecificationPrice'])->name('productServiceCategory.getspecificationPrice')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::get('category/models', [ProductModelController::class, 'getModels'])->name('category.model')->middleware(['auth', 'XSS']);
     Route::get('category/parent/specification', [ProductModelController::class, 'getParent'])->name('category.model.parent')->middleware(['auth', 'XSS']);
    Route::resource('product-models', ProductModelController::class)->middleware(['auth', 'XSS']);
    Route::resource('terms-group', TermsGroupController::class)->middleware(['auth', 'XSS']);
    Route::resource('terms-variant', TermsVariantController::class)->middleware(['auth', 'XSS']);
    ...
    Route::group(
        [
            ...
            Route::get('customer/details', [CustomerController::class, 'getDetails'])->name('customer.single.record');
...
//        Route::get('report/profit-loss-summary', [ReportController::class, 'profitLossSummary'])->name('report.profit.loss.summary');
    ...
    // Route::resource('reminder', ReminderController::class)->middleware(['auth', 'XSS']);
    Route::get('/reminder', [ToDoController::class, 'getReminder'])->name('reminder.index')->middleware(['auth', 'XSS']);
    Route::post('/calendar/reminder', [ToDoController::class, 'getCalReminder'])->name('reminder.calendar')->middleware(['auth', 'XSS']);
    Route::post('/read/reminder', [ToDoController::class, 'getReadReminder'])->name('reminder.read')->middleware(['auth', 'XSS']);
    Route::resource('jobcards', JobCardController::class)->middleware(['auth', 'XSS']);
    Route::get('/jobcards/{id}/email', [JobCardController::class, 'sendJobcardEmail'])->name('jobcard.emails.send')->middleware(['auth', 'XSS']);
    Route::post('/quotation/acknowledgement', [QuotationController::class, 'SendQuotationEmail'])->name('quotation.emails.send')->middleware(['auth', 'XSS']);
     Route::get('/quotation/{id}/cc', [QuotationController::class, 'SendQuotationEmailCC'])->name('quotation.emails.cc')->middleware(['auth', 'XSS']);
    // end Deal Module
    ...
    Route::get('/leads/search', [LeadController::class, 'search'])->name('leads.search')->middleware(['auth', 'XSS']);
    Route::get('/leads/searchSingle', [LeadController::class, 'searchSingle'])->name('leads.search.single')->middleware(['auth', 'XSS']);
    Route::get('/quotations/searchSingle', [QuotationController::class, 'searchSingleQuote'])->name('quotation.search.single')->middleware(['auth', 'XSS']);
    ...
    Route::post('/quotations/{id}/convert', [LeadController::class, 'convertToDealQuote'])->name('quotation.convert.to.deal')->middleware(['auth', 'XSS']);
    Route::get('/leads/export', [LeadController::class, 'export'])->name('leads.export')->middleware(['auth', 'XSS']);
    Route::get('/leads/download/sample', [LeadController::class, 'sample'])->name('leads.download.sample')->middleware(['auth', 'XSS']);
    ...
    Route::get('/quotation/convert-to-customer/{id}', [LeadController::class, 'convertToCustomer'])->name('quotation.convert.customer')->middleware(['auth', 'XSS']);
    Route::get('/check/email', [LeadController::class, 'checkemail'])->name('lead.email.check')->middleware(['auth', 'XSS']);
    // end Leads Module
...
//    Route::get('{id}/plan-get-payment-status', [PaypalController::class, 'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::post('update/po', [CustomerController::class, 'updatePo'])->name('customer.po');
    ...
    Route::get('quotation/send/{id}', [QuotationController::class, 'save_send'])->name('quotation.send');
    Route::get('quotation/repeat/confirmation/{id}', [QuotationController::class, 'repeatQuotationConfirm'])->name('quotation.repeat.confirmation');
    Route::get('quotation/repeat/{id}', [QuotationController::class, 'repeatQuotation'])->name('quotation.repeat');
    ...
    Route::post('quotation/barcode', [QuotationController::class, 'storeBarcode'])->name('quotation.store.barcode');
    ...
    Route::get('jobcard/field/model/{id}', [QuotationController::class, 'jobcard_field_form'])->name('jobcard.field.edit');
    Route::post('jobcard/field/{id}', [QuotationController::class, 'jobcard_field_save'])->name('jobcard.field.update');
