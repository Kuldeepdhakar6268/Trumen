...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Sales & CRM Reports')}}</li>
@endsection
@section('content')
                                    ...
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-INR-accountdashboard">
                                                  <img src="{{asset('assets/images/dashboard/sale-icon.png')}}" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Lead')}} <br> {{__('Reports')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-customer-accountdashboard">
                                                  <img src="{{asset('assets/images/dashboard/invoice-icon.svg')}}" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('invoice')}} <br> {{__('Reports')}}</p>
                                    ...
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-order-accountdashboard">
                                                   <img src="{{asset('assets/images/dashboard/order-icon.png')}}" alt="" style="height: 50px;">
                                            </div>
                                              <h3 class="mb-0 mt-3">{{$createdOrders}}</h3>
                                                <span class="percent-heading">+{{round($orderPer,2)}}% </br>from yesterday</span>
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Product')}} <br> {{__('Reports')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Payment')}} <br> {{__('Reports')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0">{{__(' Manufacturing')}}</h4>
                                        ...
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#DF7C7C;"></span>
                                               ...
                                               {{$lastMonth_pendingOrder}} Order Pending
                                            </div>
                                              
                                              <div class="mt-2">
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#2EAF2B;"></span>

                                                {{$lastMonth_completeOrder}} Order Completed
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0">{{__('Total Pending Order For Dispatch')}}</h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Finance Reports')}}</h4>
                                    <div class="view-button-accountdashboard">
