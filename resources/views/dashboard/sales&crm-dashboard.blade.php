                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Leads')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Customers')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Order')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Interested')}} <br> {{__('Leads')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0">{{__('Total Customer Pending Leads')}}</h4>
                                        ...
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <div class="mt-2">
                                               ...
                                               {{$lastMonth_pendingOrder}} call Pending
                                            </div>
                                              ...
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#2EAF2B;"></span>
                                                ...
                                                {{$lastMonth_completeOrder}} call Completed
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0">{{__('Total Converted Customer')}}</h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Total Customer Area Pending Payment')}}</h4>
                                    <div class="view-button-accountdashboard">
