                                    ...
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-INR-accountdashboard">
                                                  <img src="{{asset('assets/images/dashboard/product-stock-icon.svg')}}" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Product')}} <br> {{__('Stock')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-customer-accountdashboard">
                                                  <img src="{{asset('assets/images/dashboard/material-stock-icon.svg')}}" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Matarial')}} <br> {{__('Stock')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Dead')}} <br> {{__('Product')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Dead')}} <br> {{__('Material')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0">{{__('Available Stokes ')}}</h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Total Orders')}}</h4>
                                    <div class="view-button-accountdashboard">
