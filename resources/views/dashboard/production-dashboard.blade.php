                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Production')}} <br> {{__('Entity')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Production')}} <br> {{__('Invoice')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Production')}} <br> {{__('Reports')}}</p>
                                    ...
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-invoice-accountdashboard">
                                                    <img src="{{asset('assets/images/dashboard/delete.svg')}}" alt="" style="height: 30px;">
                                            </div>
                                             <h3 class="mb-0 mt-3">{{\Auth::user()->countInvoices()}} </h3>
                                                                                         <span class="percent-heading">0.5% </br>from yesterday</span>

                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Damage')}} <br> {{__('Product')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0">{{__('Total Entries')}}</h4>
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0">{{__('New Product')}}</h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Material Entries')}}</h4>
                                    <div class="view-button-accountdashboard">
