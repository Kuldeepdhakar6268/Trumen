                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Employee')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-customer-accountdashboard">
                                                  <img src="{{asset('assets/images/dashboard/customer-icon.png')}}" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('New')}} <br> {{__('Employee')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Department')}}</p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Designation')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0">{{__('Login Report')}}</h4>
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0">{{__('Employee Feedback')}}</h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
...
<div class="col-md-4" >
    <div class="card"style="height:516px;"  >
        <div class="card-header">
           <div class="d-flex justify-content-between">
                  <h4 class="mt-1 mb-0">{{__('Open Positions')}}</h4>
                  <div class="view-button-accountdashboard">
                      <button>view</button>
                      <i class='bx bx-chevron-right side-arrow-view-dashboard'></i>
                    </div>
        ...
        <div class="card-body m-0 p-0">
           <table>
            ...
            <tr>
                ...
                <img src="{{asset('assets/images/dashboard/position-status-complete.svg')}}" alt="" style="height: 20px;">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="d-flex justify-content-center">
                <img src="{{asset('assets/images/dashboard/position-status-pending.svg')}}" alt="" style="height: 20px;">
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Department Performance')}}</h4>
                                    <div class="view-button-accountdashboard">
