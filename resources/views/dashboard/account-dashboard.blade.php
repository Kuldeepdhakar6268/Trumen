                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Sales')}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600">{{__('Total')}} <br> {{__('Invoicing')}}</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0">{{__('Total Pending order for Manufacturing')}}</h4>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0">{{__('Total Pending Payment')}}</h4>
                                    <div class="view-button-accountdashboard">
