                ...
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between w-100" style="padding-top: 10px;">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab3" data-bs-toggle="pill" href="#item" role="tab" aria-controls="pills-item" aria-selected="true">{{__('Product Report')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-bs-toggle="pill" href="#customer" role="tab" aria-controls="pills-customer" aria-selected="false">{{__('Customer Report')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade fade show active" id="item" role="tabpanel" aria-labelledby="profile-tab3">
                                    ...
                                    <table class="table pc-dt-simple" id="item-reort">
                                        <thead>
                                        <tr>
                                            <th width="33%"> {{__('Item')}}</th>
                                            <th width="33%"> {{__('Quantity')}}</th>
                                ...
                                <div class="tab-pane fade fade" id="customer" role="tabpanel" aria-labelledby="profile-tab3">
                                    ...
                                    <table class="table pc-dt-simple" id="customer-report">
                                        ...
                                        <tr>
                                            ...
                                            <th width="33%"> {{__('Total Invoice')}}</th>
                                            <th width="33%"> {{__('Amount')}}</th>
                                            <th class="text-end"> {{__('Amount With Tax')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
