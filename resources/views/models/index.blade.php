...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Product Model')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
       {{-- <a href="#" data-size="md"  data-bs-toggle="tooltip" title="{{__('Import')}}" data-url="{{ route('productservice.file.import') }}" data-ajax-popup="true" data-title="{{__('Import product CSV file')}}" class="btn btn-sm btn-primary">
        ...
        <a href="#" data-size="md" data-url="{{ route('product-models.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create New Model')}}" class="btn btn-sm btn-primary">
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tbody>
                            @foreach ($models as $productService)
                                    ...
                                    @if(Gate::check('edit product & service') || Gate::check('delete product & service'))
                                        <td class="Action">
                                           ...
                                           {{-- <div class="action-btn bg-warning ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('product-models.detail',$productService->id) }}"
                                                ...
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="{{ route('product-models.edit',$productService->id) }}" data-ajax-popup="true"  data-size="md" data-bs-toggle="tooltip" title="{{__('Edit')}}"  data-title="{{__('Edit Materials')}}">
                                            ...
                                            @can('delete product & service')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['product-models.destroy', $productService->id],'id'=>'delete-form-'.$productService->id]) !!}
