...
@push('script-page')
    ...
    <script>
        ...
        $(document).on('change', '#customer_id', function () {
            ...
            var url = $(this).data('url');
             $.ajax({
            url: '{{route('customer.single.record')}}',
            type: 'get',
            data: {
                "id": id,
                "_token": "{{ csrf_token() }}",
        ...
        $(document).on('change', '.selectcurrency', function () {
            ...
            if(Mamt != ''){
             ...
             }else
             {
                 ...
                 $('.cSymbol').text('{{\Auth::user()->currencySymbol()}}')
                 if(totalInr>0){
                        $(this).parent().parent().parent().find('.price').empty();
    ...
    $(document).on('change', '.group-material-0', function () {
        ...
        $.ajax({
            url: '{{route('productServiceCategory.getspecificationPrice')}}',
            type: 'POST',
            data: {
                "type": type,
                "id": id,
        ...
        // else{
        //   show_toastr('Error', "{{__('Please select another options!')}}", 'error');
        //   return false;  
        // }
    });
...
<div class="modal-body">
    <div class="row">
               ...
               <h4 class="m-b-10 breadcrumb-item" style="padding-bottom:40px;padding-left:10px;">
                   <a href="{{route('quotation.index')}}" class="text-dark" style="font-weight: bolder;"> <i class="bx bx-undo"></i>{{__('Add New Quotation')}}</a>
    </h4>
                </div>
                
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <input type="submit" value="{{__('Save')}}" class="btn btn-sm custom-file-uploadss" style="padding: 10px 12px 10px 10px;float: right;">
             ...
             <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                         <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('customer_id', __('Company'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::select('customer_id', $customers,'', array('class' => 'form-control select2','required'=>'required', 'id' => 'customer_id')) }}
                                    {{ Form::hidden('company_name', null, ['class' => 'form-control','placeholder' => __('Enter Company Name'),'required'=>'required', 'id' => 'company_name']) }}
                                </div>
                            </div>
                               {{--<div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    {{ Form::label('courtesy', __('Courtesy'),['class'=>'form-label']) }}
                                <select class="form-control" name="prefix" id="select_prefix">
                                 ...
                                 <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('customer_name', __('Customer'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('customer_name',null,  ['class' => 'form-control','placeholder' => __('Enter Customer Name')]) }}
                                </div>
                            </div>
                            
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('company_email', __('Email'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('company_email', null, ['class' => 'form-control', 'placeholder' => __('Enter Email'),'required'=>'required']) }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('company_phone', __('Number'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('company_phone', null, array('class' => 'form-control', 'id' => 'phone', 'required'=>'required' , 'placeholder' => __('Enter Phone'))) }}
                                    </div>
                                </div>
                                
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('plot', __('Plot No.'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('street', __('Street Name'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('street', null, array('class' => 'form-control select','required'=>'required','placeholder' => __('Enter Street Details'))) }}
                                    </div>
                            </div>
                             <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('area', __('Area Name'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                    {{ Form::label('pin', __('Pincode'),['class'=>'form-label']) }}<span class="text-danger">*</span>
...
"TRUMEN" is an ISO 9001-2015  manufacturer and experier at level control instruments and our list of instrument', ['class'=>'form-control pro_description','rows'=>'5','placeholder'=>__('Please Add Content Here...')]) }}</div>
                    ...
                    <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        1. {{ Form::label('terms_price', __('Price'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8" style="height: 4.0rem;">
                                    <div class="form-group row">
                                          <div class="col-md-6 form-group">
                                          {{ Form::text('terms_price','FOR Site', ['class'=>'form-control','placeholder'=>__('Ex Works, Indore.'), 'id' => 'terms_price','required'=>'required','readonly']) }}
                                            </div>
                                ...
                                <div class="col-md-4 text-center" style="display:none;margin-top: 1rem;" id="pandf3">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        2. {{ Form::label('p_f', __('P & F'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8" style="display:none;margin-top: 1rem;" id="pandf4">
                                    <div class="form-group row" style="height: 2.3rem;">
                                          ...
                                          <div class="col-md-6 form-group">
                                            {{ Form::text('p_fss','Extra @',  ['class'=>'form-control','id' => 'p_f1','placeholder'=>__('Enter Packing Ex: 25%.')]) }}
                                            </div>
                                    ...
                                    <div class="form-group row" style="height: 2.3rem;">
                                          ...
                                          <div class="col-md-6 form-group">
                                            {{ Form::text('p_f_next','Extra @', ['class'=>'form-control','disabled','id' => 'p_f2','placeholder'=>__('Enter Packing Ex: 25%.')]) }} 
                                            </div>
                                ...
                                <div class="col-md-8" id="pandf2">
                                   <div class="form-group row" style="height: 2.3rem;margin-top: 1rem;">
                                    ...
                                    <div class="col-sm-5">
                                      {{ Form::text('p_fs','Extra @ 2.5%',['class'=>'form-control','disabled','id' => 'p_fs']) }}
                                    </div>
                                  </div>
                                </div>
                                 <hr>
                                <div class="col-md-4 text-center" id="taxes1">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        3. {{ Form::label('taxes', __('Taxes'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8" id="taxes2">
                                      <div class="form-group row" style="height: 2.3rem;">
                                          ...
                                          <div class="col-md-6 form-group">
                                            {{ Form::text('taxes','GST @ 18%', ['class'=>'form-control','required'=>'required']) }} 
                                            </div>
                                ...
                                <div class="col-md-4 text-center" id="freight1">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        4. {{ Form::label('freight', __('Freight'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8" id="freight2">
                                    <div class="form-group row" style="height: 2.3rem;">
                                          <div class="col-md-6 form-group">
                                          {{ Form::text('freight','Extra at actual through your approved freight carrier.', ['id' => 'freight', 'class'=>'form-control','placeholder'=>__('Extra at actual through your approved freight carrier.')]) }}
                                            </div>
                                           <div class="col-sm-6 commp"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        5. {{ Form::label('transit_insurance', __('Transit Insurance'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8">
                                     <div class="form-group row" style="height: 2.3rem;">
                                 ...
                                 <div class="col-md-4 text-center" style="display:none;margin-top: 1rem;" id="bank1">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        6. {{ Form::label('Transaction', __('Bank Transaction Charges'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8" style="display:none;margin-top: 1rem;"  id="bank2" style="height: 3.5rem;">
                                     <div class="form-group row">
                                          <div class="col-md-6 form-group">
                                             {{ Form::text('transaction',null, ['class'=>'form-control','placeholder'=>__('Applicable to your account.')]) }}
                                            </div>
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        7. {{ Form::label('delivery', __('Delivery'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group row" style="height: 2.3rem;">
                                          ...
                                          <div class="col-md-5 form-group">
                                            {{ Form::text('delivery',null,['class'=>'form-control','required'=>'required','placeholder'=>__('Within Ex: 5.')]) }} 
                                            </div>
                                 ...
                                 <div class="col-md-4 text-center">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;height: 2.3rem;">
                                        8. {{ Form::label('payment', __('Payment'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group row" style="height: 2.3rem;">
                                        ...
                                        <div class="col-sm-5">
                                          {{ Form::text('payments','100%',['class'=>'form-control','disabled','id' => 'payment']) }}
                                        </div>
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        9. {{ Form::label('warranty', __('Warranty'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8" style="height: 4.3rem;">
                                     <div class="form-group row">
                                          <div class="col-md-6 form-group">
                                             {{ Form::number('warranty','12', ['class'=>'form-control','placeholder'=>__('Enter Payment Ex: 12.')]) }}
                                            </div>
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        10. {{ Form::label('validity', __('Validity of Offer'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8" style="height: 3.6rem;">
                                     <div class="form-group row" >
                                          <div class="col-md-6 form-group">
                                            {{ Form::number('validity','30',['class'=>'form-control','placeholder'=>__('Enter Validity')]) }} 
                                            </div>
                                ...
                                <div class="col-md-4 text-center" style="height: 4.0rem;">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        11. {{ Form::label('release_po', __('Release of PO'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8" style="height: 2.3rem;">
                                    <div class="form-group row">
                                          <div class="col-md-6 form-group">
                                            {{ Form::text('release_po','Formal order mentioning your delivery address and dispatch instructions.',['class'=>'form-control','placeholder'=>__('Enter Release PO')]) }} 
                                            </div>
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="form-group" style="margin-left: 160px;text-align: justify;">
                                        12. {{ Form::label('cancellation', __('Cancellation Charges'),['class'=>'form-label']) }}
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group row" style="margin-bottom: 0.3rem;">
                                          <div class="col-md-6 form-group">
                                            {{ Form::text('cancellation','50%',['class'=>'form-control','placeholder'=>__('Enter Cancellation Ex: 50%.')]) }} 
                                            </div>
             ...
             <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                               ...
                               <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('sender_name', __('Sender Name'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('sender_name',auth()->user()->name, ['class' => 'form-control', 'placeholder' => __('Enter Sender Name'),'required'=>'required']) }}
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('address', !empty($Uaddress->employee)?$Uaddress->employee->address:auth()->user()->address, ['class' => 'form-control', 'placeholder' => __('Enter Sender Address'),'required'=>'required']) }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('sender_number', __('Number'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('contact', !empty($Uaddress->employee)?$Uaddress->employee->phone:auth()->user()->contact, ['class' => 'form-control', 'id' => 'sender_phone', 'placeholder' => __('Enter Sender Contact No.'),'required'=>'required']) }}

                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('sender_email', __('Email'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('sender_email',auth()->user()->email, ['class' => 'form-control', 'placeholder' => __('Enter Sender Email'),'required'=>'required']) }}

                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('sender_website', __('Website'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('sender_website', 'www.trumen.com', ['class' => 'form-control', 'placeholder' => __('Enter Website'),'required'=>'required']) }}
        ...
        @endphp
        <div class="col-12">
            <h5 class=" d-inline-block mb-4" style="padding-left: 30px;">{{__('Product & Services')}}</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="items" id="Qtable">
                            ...
                            <tr>
                               ...
                               {{-- <th>{{__('Discount')}}</th>
                                <th>{{__('Tax')}} (%)</th>--}}
                                <th class="text-end">{{__('Total')}} <span class="cSymbol">({{\Auth::user()->currencySymbol()}})</span></th>
                                <th></th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                <td width="20%" class="form-group pt-1" style="margin-bottom: 0.3rem;">
                                    <div class="item_div">
                                        ...
                                        {{ Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('quotation.product'),'required'=>'required','style' => 'margin-bottom: 13px;')) }}
                                    </div>
                                </td>
                                 <td width="25%">
                                    <div class="form-group">
                                        {{ Form::text('model','', array('class' => 'form-control model ordering-serise','placeholder'=>__('Model'),'required'=>'required')) }}
                                         {{ Form::hidden('models','', array('class' => 'form-control models ordering-serises','placeholder'=>__('Model'))) }}
                                       
                                    </div>
                                </td>
                                 <td>
                                    <div width="10%" class="form-group pt-1">
                                        {{ Form::select('application', $applications,'null', array('class' => 'form-control select2 AppSelect','required'=>'required')) }}
                                       
                                    </div>
                                </td>
                                 <td>
                                    <div class="form-group pt-1 AppText" style="width: 103px;display:none;">
                                        {{ Form::text('application_text',null, array('class' => 'form-control','placeholder'=>__('Application'))) }}
                                 ...
                                 {{ Form::hidden('quantity','', array('class' => 'form-control quantity','placeholder'=>__('Qty'),'required'=>'required')) }}
                               <td>
                                ...
                                <td width="15%">
                                    <div class="form-group price-input input-group search-form">
                                        {{ Form::hidden('slname','', array('class' => 'form-control slname')) }}
                                        {{ Form::hidden('slid','', array('class' => 'form-control slid')) }}  
                                        {{ Form::hidden('desc','', array('class' => 'form-control desc')) }}
                                        {{ Form::hidden('check_length','', array('class' => 'form-control check_length')) }}
                                        {{ Form::hidden('ids','', array('class' => 'form-control ids')) }}  
                                        {{ Form::text('price','0.00', array('class' => 'form-control price','required'=>'required','placeholder'=>__('Price'))) }}
                                        {{ Form::hidden('price_usd','0.00', array('class' => 'form-control price_usd')) }}
                                        {{ Form::hidden('price_euro','0.00', array('class' => 'form-control price_euro')) }}
                                        {{ Form::hidden('price_inr','0.00', array('class' => 'form-control price_inr')) }}
                                        {{ Form::hidden('base_price','0.00', array('class' => 'form-control base_price')) }}
                                        {{ Form::hidden('base_price_usd','0.00', array('class' => 'form-control base_price_usd')) }}
                                        {{ Form::hidden('base_price_euro','0.00', array('class' => 'form-control base_price_euro')) }}
                                        {{ Form::hidden('base_serial','0.00', array('class' => 'form-control base_serial')) }}
                                        ...
                                        <select class="form-control selectcurrency" name="currency" style="border-radius: 3px;width: 57px;">
                                         ...
                                         {{ Form::hidden('group_id','', array('class' => 'form-control group_id')) }}
                                         {{ Form::hidden('product_model_id','', array('class' => 'form-control product_model_id')) }}
                                         {{ Form::hidden('m_price','', array('class' => 'form-control m_price')) }}
                                         {{ Form::hidden('length_price_inr','0.00', array('class' => 'form-control length_price_inr')) }}
                                         {{ Form::hidden('length_price_usd','0.00', array('class' => 'form-control length_price_usd')) }}
                                         {{ Form::hidden('length_price_euro','0.00', array('class' => 'form-control length_price_euro')) }}
                                         {{ Form::hidden('usd_sale_price','', array('class' => 'form-control usd_sale_price')) }}
                                         {{ Form::hidden('euro_sale_price','', array('class' => 'form-control euro_sale_price')) }}
                                    </div>
                                </td>
                          ...
                          {{-- <tr class="integral d-none" id="Integral">
                                <td colspan="4">
                                    <div class="form-group"> 
                                    <label for="selectOptionIntegral">Integral/Slit/Flexible</label>
                                    <select id="selectOptionIntegral" class="form-control" name="integral" >
                                ...
                                <td colspan="3" class="fd_cd_options d-none">
                                 <div class="form-group"> 
                                    <label for="fd_cd">Select FD/CD</label>
                                    <select id="fd_cd" class="form-control" name="fd_cd" >
                            ...
                            <tr>
                                ...
                                <div class="inline-container" style=" display: flex;align-items: center;gap: 10px;">
                                 ...
                                 {{ Form::hidden('id_check','0', array('class' => 'form-control','placeholder'=>__('Discount'), 'id' => 'id_check')) }}
                               </td>
                              
                                <td> {{ Form::text('manual','', array('class' => 'form-control manual_discount','placeholder'=>__('Enter Discount'), 'id' => 'mDiscount')) }}</td>
                                 <td></td>
                                  <td></td>
                                <td><strong>{{__('Sub Total')}}</strong></td>
                                <td class="text-end subTotal" id="sub_total">0.00 </td>
                                <td><span class="cSymbol">{{\Auth::user()->currencySymbol()}}</span></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
