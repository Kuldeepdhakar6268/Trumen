...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
       ...
       <li class="breadcrumb-item"><a href="{{ $id==0?route('leads.show',  $_GET['lead_id']):route('leads.edit', $_GET['lead_id'])}}">{{__('Lead')}}</a></li>
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       {{Form::date('quotation_date',$Cdata,array('class'=>'form-control','required'=>'required'))}}
                                    ...
                                    <div class="form-group">
                                         ...
                                         @if(!empty($lead->products()))
                                                 @foreach($lead->sources() as $source) 
                                                   ...
                                                   @endforeach
                                                   @else
                                                    {{ Form::text('enquiry_ref', null, ['class' => 'form-control']) }}
                                                   @endif
                            ...
                            <div class="col-md-6">
                                ...
                                @endphp
                                    ...
                                    {{ Form::text('gst_number',$txtno, array('class' => 'form-control select')) }}
                                    </div>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('company_name', $lead->industry_name, ['class' => 'form-control','required'=>'required' ]) }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('phone', __('Number'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('company_phone', $lead->phone, array('class' => 'form-control','id'=>'phone', 'required'=>'required' , 'placeholder' => __('Enter Phone'), 'style' => 'padding-left:90px')) }}
                                    </div>
                                </div>
                                  <div class="col-md-4">
                                   <div class="form-group">
                                        {{ Form::label('email', __('Email'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('company_email', $lead->email, ['class' => 'form-control','required'=>'required']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('ploat_no', __('Plot No.'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                        {{ Form::text('plot', null, ['class' => 'form-control','required'=>'required']) }}
                            ...
                            <div class="col-md-4">
                                    ...
                                    {{ Form::text('street',null, array('class' => 'form-control select','required'=>'required','required'=>'required')) }}
                                    </div>
                            </div>
                             <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('area_name', __('Area Name'),['class'=>'form-label']) }}
                                    {{ Form::text('area', null, array('class' => 'form-control select','required'=>'required','required'=>'required')) }}
                                    </div>
                            </div>
                            <div class="col-md-4">
                                <input type="hidden" value="{{$leadCustomer?$leadCustomer->lead_id:0}}" name="lead_id">
                                    <div class="form-group">
                                    {{ Form::label('pincode', __('Pincode'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('pin', $zip, array('class' => 'form-control select','required'=>'required')) }}
                                    </div>
                            </div>
                            <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('city', __('City'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('city', $city, array('class' => 'form-control select','required'=>'required')) }}
                                    </div>
                            </div>
                            <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('state', __('State'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('state', $state, array('class' => 'form-control select','required'=>'required')) }}
                                    </div>
                            </div>
                            <div class="col-md-4">
                                    <div class="form-group">
                                    {{ Form::label('country', __('Country'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('country', $country, array('class' => 'form-control select','required'=>'required')) }}
                                    </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <option value="Ms." {{$cprefix == 'Ms.'?'selected': ''}}>Ms.</option>
                                    ...
                                    <div class="form-group">
                                    {{ Form::label('attention', __('Kind Attention'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                    {{ Form::text('attention', $lead->customer->name, array('class' => 'form-control select','required'=>'required', 'style' => 'padding-left:90px')) }}
                                    </div>
                            </div>
                    </div>
                </div>    
                    ...
                    <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                          {{ Form::textarea('subject', $description, ['class' => 'form-control summernote-simple', 'style' => 'width: 100%;','placeholder' => __('Enter Description')]) }}
           ...
           ?>
             ...
             <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            Dear {{$lead->customer->name}} {{$lead->customer->prefix == 'Mr.'?'Sir':(($lead->customer->prefix == 'Mrs.')?'Madam':(($lead->customer->prefix == 'Ms.'?'Sister':'')))}} with reference to your enquiry for Requirment of {{$product}}, we are please to submit here unde our offer 
                            for the same.
                                ...
                                <div class="col-md-8" style="height: 3.5rem;">
                                    <div class="form-group row">
                                          ...
                                          <div class="col-md-5 form-group">
                                            {{ Form::text('delivery',null,['class'=>'form-control','required'=>'required','placeholder'=>__('Enter Delivery Weeks Ex: 5.')]) }} 
                                            </div>
            ...
            <!--Sender Address-->
             <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <input type="hidden" name="customer_id" value="{{$leadCustomer?$leadCustomer->id:0}}">
                               <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('sender_name', __('Sender Name'),['class'=>'form-label']) }}
                                        {{ Form::text('sender_name',auth()->user()->name, ['class' => 'form-control']) }}
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('address',!empty($Uaddress->employee)?$Uaddress->employee->address:auth()->user()->address, ['class' => 'form-control']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact',!empty($Uaddress->employee)?$Uaddress->employee->phone:auth()->user()->contact, ['class' => 'form-control', 'id' => 'sender_phone']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('sender_email',auth()->user()->email, ['class' => 'form-control']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('sender_website', 'www.trumen.com', ['class' => 'form-control']) }}
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="   ">
                            ...
                            <tr>
                                <td width="20%" class="form-group pt-1">
                                 ...
                                 <td width="25%">
                                    <div class="form-group">
                                        {{ Form::text('model','', array('class' => 'form-control model ordering-serise', 'required'=>'required','placeholder'=>__('Model'),'required'=>'required')) }}
                               ...
                               <td width="13%">
                                ...
                                <td width="20%">
                                    <div class="form-group price-input input-group search-form">
                                        ...
                                        {{ Form::text('price','', array('class' => 'form-control price','placeholder'=>__('Price'),'required'=>'required', 'readonly')) }}
                                        {{ Form::hidden('group_id','', array('class' => 'form-control group_id')) }}
                                        {{ Form::hidden('model_prefix','', array('class' => 'form-control model_prefix')) }}
                                        ...
                                        <select class="form-control selectcurrency" name="currency" style="border-radius: 3px;width: 57px;">
                                         ...
                                         {{ Form::hidden('length_price','0.00', array('class' => 'form-control length_price')) }}
                            ...
                            <tr>
                                ...
                                <td> {{ Form::text('manual_discount','', array('class' => 'form-control manual_discount','placeholder'=>__('Enter Discount'),'id' =>'mDiscount')) }}</td>
                                <td></td>
                                <td></td>
