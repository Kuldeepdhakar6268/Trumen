...
@section('content')
  ...
  <div class="card" style="">
    <div class="row"style="margin-top: 70px;">
       ...
       <span style="float: inline-end;"><i class="ti ti-filter" style="position: absolute;margin-left: 14px;margin-top: 12px;z-index: 10;color: white;"></i><input type="submit" title="{{__('Search')}}" data-bs-toggle="tooltip" class="btn btn-primary text-primary form-control" style="border: none;width: 40px;" onmouseover="this.style.backgroundColor='var(--color-customColor)';'"></span>
                   ...
                   <div class="col-sm-2 form-group" style="position: relative;">
                        <input type="text" class="form-control text-primary" name="date" value="Date" placeholder="Date" title="{{__('Date')}}" data-bs-toggle="tooltip" id="datepicker" style="border-radius: 15px; padding-right: 30px;">
        ...
        <div class="col-md-12 content">
           <h4 class="m-b-10"><a href="#" class="text-dark" style="font-weight: bolder;margin-left: 20px;">{{__('Recent Search')}}</a></h4>
