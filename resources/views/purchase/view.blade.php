...
@section('content')
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table ">
                                            ...
                                            @foreach($iteams as $key =>$iteam)
                                                ...
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>{{!empty($iteam->orderRequest)?$iteam->orderRequest->material->material_name:''}}</td>
    ...
    <div class="row">
        ...
        <div style="margin:3rem ; line-height: 2rem;">
            ...
            <div>
            <p>{{!empty($purchase->terms)?$purchase->terms->price:''}}</p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            @if($purchase->terms)
            <div>
            <p> GST @ {{!empty($purchase->terms)?$purchase->terms->p_f:''}}</p>
            </div>
            @else
            <div>
            <p> {{!empty($purchase->terms)?$purchase->terms->p_f_next:''}}</p>
            </div>
            @endif
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem;border-top: 3px solid #f1eeee; border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <p>{{!empty($purchase->terms)?$purchase->terms->taxes:''}}</p>
            </div>
            </div>
            ...
            <div>
            <p>{{!empty($purchase->terms)?$purchase->terms->freight:''}}</p>
            </div>
            </div>
            ...
            <div>
            <p>{{!empty($purchase->terms)?$purchase->terms->insurance:''}}.</p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            <p style="border-right:3px solid #f1eeee;">6. Delivery</p>
            <div>
            <p> Within {{!empty($purchase->terms)?$purchase->terms->delivery:''}} weeks after confirmed order.</p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem;border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            @if(!empty($purchase->terms))    
            <p>{{$purchase->terms->payment == '100%'?'100% Against proforma invoice prior to dispatch.':$purchase->terms->payment}}</p>
            @endif
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <p>{{!empty($purchase->terms)?$purchase->terms->warranty:''}} months from the date of commissioning or fifteen months from the date of supply
                which ever is earlier.</p>
                </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            <p style="border-right:3px solid #f1eeee;">9. Validity of offer</p>
            <p>{{!empty($purchase->terms)?$purchase->terms->validity_offer:''}} Days</p>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <p style="">{{!empty($purchase->terms)?$purchase->terms->cancellation_charges:''}}% Of PO amount to be paid if cancelled after order acceptance.</p>
            </div>
            ...
            <p style="margin-top: 0.2rem; margin-bottom: 0.2rem; font-weight: 550;" class="ftr">{{!empty($purchase->createdBy)?$purchase->createdBy->name:''}}</p>
            ...
            <p class="ftr">39, Mangal Nagar, Behind Sai Ram Plaza
                ...
                <p class="ftr">Tel: 0731-4972065, {{!empty($purchase->createdBy)?$purchase->createdBy->contact:''}}</p>
                <p class="ftr">Email: {{!empty($purchase->createdBy)?$purchase->createdBy->email:''}}, Web: www.trumen.in</p>
                </div>
        </div>
