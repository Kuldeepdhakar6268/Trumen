    ...
    <div class="row">
        ...
        {{--<div class="col-md-6 form-group">
         ...
         {{--<div class="form-group col-md-6">
            ...
            {{ Form::select('group_id',null, array('class' => 'form-control select','required'=>'required', 'id' => 'groups')) }}
         ...
         <div class="form-group col-md-6">
            ...
            {{ Form::select('product_model_id',null, array('class' => 'form-control select','required'=>'required', 'id' => 'product_model')) }}
       ...
       {{-- <div class="add_contact"><div class="row mx-2">
            <div class="col-md-2">
                <div class="form-group">
                    <label for="prefix" class="form-label">Sr. No</label>
                    <input class="form-control" placeholder="01" name="prefix[]" type="text" id="prefix_name">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {{ Form::label('parts_id', __('Parts/Description'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                    {{ Form::select('parts_id',$mList,'',array('class' => 'form-control select2 part','data-url'=>route('material.part'),'required'=>'required')) }}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label for="price" class="form-label">Unit Rate</label>
                    <input class="form-control u_price" placeholder="10" name="price[]" type="text" value="1">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label for="price" class="form-label">Quantity</label>
                    <input class="form-control qty" placeholder="100" name="price[]" type="text">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label for="price" class="form-label">Net Value INR</label>
                    <input class="form-control net_price" placeholder="1,000" name="price[]" type="text">
                </div>
            </div>
            <div class="col-md-1" style="padding-top: 25px;">
                <div class="form-group">
                    <a class="mx-3 btn btn-primary sm  align-items-cente removeButton" title="remove"><label class="form-check-label " for="g_male">
                        <i class="ti ti-trash text-white"></i></label>
                    </a>
                </div>
            </div>
             <a style="background-color:#3A9FD8;" class="btn  sm text-light repeat"><i class="ti ti-plus"></i> Add Sub-Specification</a>
        </div>
        </div> --}}
        {{-- <div id="divContainer"></div>
        <div class="form-group mx-3">
            <a style="background-color:#3A9FD8;" class="btn  sm text-light" onclick="appendDiv()"><i class="ti ti-plus"></i> Add Sub-Specification</a>
         </div>--}}
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-1">
                                    {{ Form::select('item',$product_services,'',array('class' => 'form-control select2 item','data-url'=>route('purchase.items'),'required'=>'required')) }}
                                </td>
                                 <td width="10%">
                                    <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td>{{ Form::hidden('total_amount','1', array('class' => 'form-control total_amount', 'id' => 'total_amount')) }}</td>
                            </tr>
                            </tfoot>
                        </table>
                    </div>
             ...
             <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                               ...
                               <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('sender_name', __('Prepared By'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('approvedby', __('Approved By'),['class'=>'form-label']) }}<span class="text-danger">*</span>
