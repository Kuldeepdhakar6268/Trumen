...
@section('content')
       ...
       {{-- <div class="row">
         ...
         <div class="row" style="margin-top: 50px;">
                 ...
                 {{ Form::open(array('url' => 'jobcard/search', 'id' => 'jobcard_filter')) }}
               <div class="row" style="margin-top: 70px;">
                   ...
                   <div class="col-sm-3 form-group" style="position: relative;">
                        <input type="text" class="form-control text-primary" name="date" value="Date" placeholder="Date" title="{{__('Date')}}" data-bs-toggle="tooltip" id="datepicker" style="border-radius: 15px;font-weight: bold;">
             ...
             {{Form::close()}}
        <div class="col-md-12">
                        <h4 class=""><a href="#" class="text-dark" style="font-weight: bolder;margin-left: 20px;margin-top: 50px;position:absolute;margin-bottom: -20px;">{{__('JobCard Request')}}</a></h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($quotations as $quotation)
                                    ...
                                    <tr  style="margin-top: 30px;background: #F8FAFB;">
                                        ...
                                        <td>
                                            <div class="number-color ms-2" style="font-size:12px;background-color: {{ ($quotation->is_send == 1)?'#ff5000':'#009900'}}">
                                                   {{$loop->iteration}}</div> 
                                           </td>
                                        <td class="Id">
                                            <a href="{{ route('quotation.order.view', ['id' => \Crypt::encrypt($quotation->id), 'job' => 'is_job']) }}"
                                                class="text-dark">{{ Auth::user()->soNumberFormat($quotation->jobcard_no == 0?$quotation->jobcard_no+1:$quotation->jobcard_no ) }}</a>
                                        </td>
                                        <td>{{$quotation->organization->name}}</td>
