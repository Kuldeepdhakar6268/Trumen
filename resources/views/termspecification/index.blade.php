...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Terms Variation')}}</li>
@endsection
@section('action-btn')
    <div class="float-end">
       {{-- <a href="#" data-size="md"  data-bs-toggle="tooltip" title="{{__('Import')}}" data-url="{{ route('productservice.file.import') }}" data-ajax-popup="true" data-title="{{__('Import product CSV file')}}" class="btn btn-sm btn-primary">
        ...
        <a href="#" data-size="xl" data-url="{{ route('terms-variant.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add details')}}" class="btn btn-sm btn-primary">
