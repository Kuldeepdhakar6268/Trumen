{{ Form::open(array('url' => 'terms-variant','enctype' => "multipart/form-data")) }}
   ...
   {{-- @if($plan->chatgpt == 1)
    ...
    <div class="row">
        <div class="form-group col-md-4">
            {{ Form::label('term_id', __('Group'),['class'=>'form-label']) }}<span class="text-danger">*</span>
            {{ Form::select('term_id', $group,null, array('class' => 'form-control select','required'=>'required')) }}
        ...
        {{--<div class="col-md-4">
            <div class="form-group">
                ...
                {{ Form::text('name', '', array('class' => 'form-control','required'=>'required', 'placeholder'=>__('Enter variation Name'))) }}
            </div>
        </div>--}}
        <div class="col-md-8">
            <div class="form-group">
                {{ Form::label('details', __('Details'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {{ Form::text('details', '', array('class' => 'form-control','required'=>'required', 'placeholder'=>__('Enter variation Details'))) }}
            </div>
        </div>
