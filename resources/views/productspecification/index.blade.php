...
@section('action-btn')
    <div class="float-end">
       {{-- <a href="#" data-size="md"  data-bs-toggle="tooltip" title="{{__('Import')}}" data-url="{{ route('productservice.file.import') }}" data-ajax-popup="true" data-title="{{__('Import product CSV file')}}" class="btn btn-sm btn-primary">
        ...
        <a href="#" data-size="xl" data-url="{{ route('productspecification.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create Specification')}}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($productServices as $productService)
                                <tr class="font-style">
                                    ...
                                    <td>{{ !empty($productService->model)?$productService->model->name:''}}</td>
                                    <td>
                                        @php
                                        ...
                                        <td class="Action">
                                           ...
                                           @can('delete product & service')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['productspecification.destroy', $productService->id],'id'=>'delete-form-'.$productService->id]) !!}
