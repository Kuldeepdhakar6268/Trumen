...
@endsection
@section('content')
{{ Form::open(array('url' => 'leads', 'id' => 'create_lead')) }}
 ...
 <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4" style="margin-top: -52px;">
                 <span style="float: inline-end;"><input type="submit" value="{{__('Save')}}" title="{{__('Create Lead')}}" class="btn-sm custom-file-uploadss" style="border: none;"></span>
                </div>
            </div>    
<div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group">
                        {{Form::label('industry',__('Customer'),['class'=>'form-label'])}}<span class="text-danger">*</span>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group">
                        ...
                        {{Form::text('sector',null,array('class'=>'form-control','placeholder'=>_('Enter Sector Name')))}}
                    </div>
                </div>
            ...
            <h6 class="sub-title">{{__('Contact Person Information')}}</h6>
                ...
                <div class="col-sm-6" style="float: inline-end;">
                    <div class="form-group">
                        ...
                        {{Form::label('billing_name',__('Name'),array('class'=>'','class'=>'form-label')) }}<span class="text-danger">*</span>
                        {{Form::text('billing_name',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Name'),'required'=>'required', 'style' => 'padding-left: 90px'))}}
                    </div>
                </div>
                ...
                <div class="col-sm-6" style="float: inline-end;">
                    <div class="form-group">
                        {{Form::label('billing_phone',__('Phone'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                        {{Form::text('phone',null,array('class'=>'form-control' , 'id' => 'phone', 'placeholder'=>__('Enter Phone'),'required'=>'required'))}}
                    </div>
                </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6">
       ...
       <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            {{ Form::text('billing_email', null, array('class' => 'form-control', 'placeholder' => __('Enter email'),'required'=>'required')) }}
        </div>
       <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group">
                ...
                {{Form::label('shipping_phone',__('Phone'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                 <span>      
      ...
      <a href="#"><img src="{{ asset('assets/images/india.png') }}" width="30" alt="india"/> </a>
                ...
                {{Form::text('shipping_phone',null,array('class'=>'form-control' , 'style'=> 'padding-left: 100px;', 'placeholder'=>__('Enter Phone'),'required'=>'required'))}} </span>
            </div>
        </div>
       ...
       <div class="card" style="height: 375px;">
            <div class="card-body">
                <h6 class="sub-title">{{__('Address & Contact')}}</h6>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {{Form::label('shipping_address',__('Address'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                            <label class="form-label" for="example2cols1Input"></label>
                            {{Form::textarea('shipping_address',null,array('class'=>'form-control','rows'=>3 , 'placeholder'=>__('Enter Address'),'required'=>'required'))}}
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6" style="float: inline-start;">
                        <div class="form-group">
                            {{Form::label('shipping_country',__('Country'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                            {{Form::text('shipping_country',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Country'),'required'=>'required'))}}
        
                        </div>
                    </div>
                    <div class=" col-lg-5 col-md-5 col-sm-6" style="float: inline-end;">
                        <div class="form-group">
                            {{Form::label('shipping_state',__('State'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                            {{Form::text('shipping_state',null,array('class'=>'form-control' , 'placeholder'=>__('Enter State'),'required'=>'required'))}}
        
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6" style="float: inline-start;">
                        <div class="form-group">
                            {{Form::label('shipping_city',__('City'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                            {{Form::text('shipping_city',null,array('class'=>'form-control' , 'placeholder'=>__('Enter City'),'required'=>'required'))}}
        
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-5 col-sm-5" style="float: inline-end;">
                        <div class="form-group">
                            {{Form::label('shipping_zip',__('Zip Code'),array('class'=>'form-label')) }}<span class="text-danger">*</span>
                            {{Form::text('shipping_zip',null,array('class'=>'form-control' , 'placeholder' => __('Enter Zip Code'),'required'=>'required'))}}
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        {{ Form::text('owner_id', \Auth::user()->name, array('class' => 'form-control','required'=>'required', 'readonly')) }}
            ...
            success: function (data) {
                ...
                if(data.status == false)
                {
                   return true; 
                     ...
                     show_toastr('Error', "{{__('Email id already exist!')}}", 'error');
                      $("#email").focus();
                        return false; 
                }
            }
