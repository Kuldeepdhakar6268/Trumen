        ...
        <div class="me-auto dash-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="dropdown dash-h-item drp-company">
                    ...
                    <h3 class="hide-mob ms-2" style="font-weight: bolder;">{{__('Welcome, ')}}{{\Auth::user()->name }}</h3>
                ...
                @if( \Auth::user()->type !='client' && \Auth::user()->type !='super admin' )
                    ...
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                         <i class="ti ti-bell"></i>
                            <span class="bg-danger dash-h-badge message-toggle-msg  message-counter custom_messanger_counter beep"> {{ $findremind->count() }}<span
                                    class="sr-only"></span>
                            </span>
                    </a>
                    @if(count($findremind))
                    <div class="dropdown-menu dash-h-dropdown" style="min-width: 250px;">
                            ...
                            @foreach($findremind as $r)
                            <a href="{{route('dashboard')}}" class="dropdown-item">
                                <i class="ti ti-message text-dark"></i><span>{{$r->name}}</span>
                            </a>
