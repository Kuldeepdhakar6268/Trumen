                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::tel('phone', old('phone'), ['class' => 'form-control' , 'id'=>'phone','required' => 'required' ,'placeholder'=>'Enter employee phone'  ]) !!}
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::text('city', old('city'), ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee city name']) !!}
                                </div>
                                 <div class="form-group col-md-6">
                                    {!! Form::label('state', __('State'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('state', old('state'), ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee state name']) !!}
                                </div>
                                 <div class="form-group col-md-6">
