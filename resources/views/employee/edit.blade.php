            ...
            <div class="card emp_details">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('phone_number', __('Phone'),['class'=>'form-label']) !!}<span class="text-danger pl-1">*</span>
                            {!! Form::hidden('phone',null, ['class' => 'form-control', 'id'=> 'phone_number']) !!}
                            {!! Form::tel('tel',$employee->phone, ['class' => 'form-control', 'id' => 'phone']) !!}
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {!! Form::password('password',['class' => 'form-control', 'placeholder'=>'Enter employee new password']) !!}
                                </div>
                                <div class="form-group col-md-6">
                                    {!! Form::label('city', __('City'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('city',$employee->user->city, ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee city name']) !!}
                                </div>
                                 <div class="form-group col-md-6">
                                    {!! Form::label('state', __('State'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('state',$employee->user->state, ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee state name']) !!}
                                </div>
                                 
                          <div class="form-group col-md-6">
                                {{ Form::label('role', __('Employee Role'), ['class' => 'form-label']) }}
