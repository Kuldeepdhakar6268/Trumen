                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Production')); ?> <br> <?php echo e(__('Entry')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-customer-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/invoice-icon.svg')); ?>" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Production')); ?> <br> <?php echo e(__('Invoice')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Production')); ?> <br> <?php echo e(__('Reports')); ?></p>
                                    ...
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-invoice-accountdashboard">
                                                    <img src="<?php echo e(asset('assets/images/dashboard/delete.svg')); ?>" alt="" style="height: 30px;">
                                            </div>
                                             <h3 class="mb-0 mt-3"><?php echo e(\Auth::user()->countInvoices()); ?> </h3>
                                                                                         <span class="percent-heading">0.5% </br>from yesterday</span>

                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Damage')); ?> <br> <?php echo e(__('Product')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <span>Total Dispatch Order</span>
                                              <div class="mt-2">
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Material Entries')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> Mechanical</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Electronics</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/disptch-dashboard.blade.php ENDPATH**/ ?>