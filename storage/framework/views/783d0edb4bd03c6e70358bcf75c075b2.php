...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Sales & CRM Reports')); ?></li>
<?php $__env->stopSection(); ?>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Lead')); ?> <br> <?php echo e(__('Reports')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('invoice')); ?> <br> <?php echo e(__('Reports')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Product')); ?> <br> <?php echo e(__('Reports')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Payment')); ?> <br> <?php echo e(__('Reports')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                                 ...
                                 <div class="col-6">
                                    <div class="image-container">
                                        ...
                                        <div class="centered-text">
                                            ...
                                            <h3 style="font-size: 15px;font-weight: normal;">Orders Complete</h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-8">
                                <div class="row">
                        <div class="col-md-12 inner-dashboard-content" style="height:419px;" >
                              <h4>Purchase & Management Reports</h4>
                                <span>Last 1 Months</span>
                            <div class="row mt-3">
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Finance Reports')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> Total Expenses</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Total Income</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/reports-dashboard.blade.php ENDPATH**/ ?>