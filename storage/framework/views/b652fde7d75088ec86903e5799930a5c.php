                                    ...
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-INR-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/product-stock-icon.svg')); ?>" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Product')); ?> <br> <?php echo e(__('Stock')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-customer-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/material-stock-icon.svg')); ?>" alt="" style="height: 30px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Matarial')); ?> <br> <?php echo e(__('Stock')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Dead')); ?> <br> <?php echo e(__('Product')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Dead')); ?> <br> <?php echo e(__('Matarial')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Manufacturing')); ?></h4>
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Assailable Stokes')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Orders')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> Return Orders</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Purchas Orders</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/inventory-dashboard.blade.php ENDPATH**/ ?>