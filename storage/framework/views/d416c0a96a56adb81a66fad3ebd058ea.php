                            ...
                            <div class="row mt-3">
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-INR-accountdashboard">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-customer-accountdashboard">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Dead')); ?> <br> <?php echo e(__('Material')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#DF7C7C;"></span>
                                               ...
                                               <?php echo e($lastMonth_pendingOrder); ?> Order Pending
                                            </div>
                                             
                                              <div class="mt-2">
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#2EAF2B;"></span>

                                                <?php echo e($lastMonth_completeOrder); ?> Order Completed
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Available Stokes ')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/manufacturing-dashboard.blade.php ENDPATH**/ ?>