...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <table class="table ">
                                            ...
                                            <?php $__currentLoopData = $iteams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$iteam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(!empty($iteam->orderRequest)?$iteam->orderRequest->material->material_name:''); ?></td>
    ...
    <div class="row">
        ...
        <div style="margin:3rem ; line-height: 2rem;">
            ...
            <div>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->price:''); ?></p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <p> GST @ <?php echo e(!empty($purchase->terms)?$purchase->terms->p_f:''); ?></p>
            </div>
            <?php else: ?>
            <div>
            <p> <?php echo e(!empty($purchase->terms)?$purchase->terms->p_f_next:''); ?></p>
            </div>
            <?php endif; ?>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem;border-top: 3px solid #f1eeee; border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->taxes:''); ?></p>
            </div>
            </div>
            ...
            <div>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->freight:''); ?></p>
            </div>
            </div>
            ...
            <div>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->insurance:''); ?>.</p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            <p style="border-right:3px solid #f1eeee;">6. Delivery</p>
            <div>
            <p> Within <?php echo e(!empty($purchase->terms)?$purchase->terms->delivery:''); ?> weeks after confirmed order.</p>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem;border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <?php if(!empty($purchase->terms)): ?>    
            <p><?php echo e($purchase->terms->payment == '100%'?'100% Against proforma invoice prior to dispatch.':$purchase->terms->payment); ?></p>
            <?php endif; ?>
            </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <div>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->warranty:''); ?> months from the date of commissioning or fifteen months from the date of supply
                which ever is earlier.</p>
                </div>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            <p style="border-right:3px solid #f1eeee;">9. Validity of offer</p>
            <p><?php echo e(!empty($purchase->terms)?$purchase->terms->validity_offer:''); ?> Days</p>
            </div>
            <div class="display" style="display: grid; grid-template-columns: 1fr 3fr; justify-content: start; gap: 2rem; border-top: 3px solid #f1eeee; solid;border-right: 3px solid #f1eeee;border-left: 3px solid #f1eeee;">
            ...
            <p style=""><?php echo e(!empty($purchase->terms)?$purchase->terms->cancellation_charges:''); ?>% Of PO amount to be paid if cancelled after order acceptance.</p>
            </div>
            $purchase<p style="margin-top: 3rem;" class="ftr">Trust Our Offer Is In Line With Your Requirement. Please Feel Free To Contact Us For Further Assistance. We Look Forward To Your
                Valued Order</p>
            <p style="margin-top: 2rem;" class="ftr">Thanks And Warm Regards.</p>
            <p style="margin-top: 0.2rem; margin-bottom: 0.2rem; font-weight: 550;" class="ftr"><?php echo e(!empty($purchase->createdBy)?$purchase->createdBy->name:''); ?></p>
            ...
            <p class="ftr">39, Mangal Nagar, Behind Sai Ram Plaza
                ...
                <p class="ftr">Tel: 0731-4972065, <?php echo e(!empty($purchase->createdBy)?$purchase->createdBy->contact:''); ?></p>
                <p class="ftr">Email: <?php echo e(!empty($purchase->createdBy)?$purchase->createdBy->email:''); ?>, Web: www.trumen.in</p>
                </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/purchase/view.blade.php ENDPATH**/ ?>