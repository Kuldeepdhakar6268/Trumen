    ...
    <div class="row">
        ...
        <div class="d-flex radio-check">
                <div class="orm-check form-check-inline form-group col-md-6">
                    <input type="checkbox" name="client_check" value="new" id="new_client" class="form-check-input">
                    <label class="form-check-label form-label" for="new_client">Convert to Job Card</label>
                </div>
