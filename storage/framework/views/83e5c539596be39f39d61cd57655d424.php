     ...
     <table class="table-parent">
       ...
       <tbody>
        <tr>
            ...
            <td rowspan="2" colspan="2" class="commTD"><div class="display"><span>SO-<?php echo sprintf('%02d', $quotation->order_no == 0?$quotation->order_no+1:$quotation->order_no); ?></span><img src="<?php echo e($quotation->barcode); ?>" alt="Red dot" style="width: 130px;height: 56px;"/></td>
            <td class="commTD">Old SO_Ref</td>
            <td class="commTD"><?php echo e($quotation->old_ref_no); ?></td>
            <tr>
            <td class="commTD">Quote Ref</td>
            <td class="commTD">TTPL/<?php echo e($year); ?><?php echo e($yearNext->format('y')); ?>/<?php echo sprintf('%02d', $quotation->order_no == 0?$quotation->order_no+1:$quotation->order_no); ?></td>
            </tr>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
            ...
            <td colspan="2" style="text-align: center; font-weight: bold;" class="commTD">Quanitity</td>
        </tr>
        ...
        <p><?php echo e($keyss+1); ?>. <?php echo e($item->q_model); ?></p>
          <?php
          $qty += $item->quantity;
          ?>  
           </td>
             ...
             <?php $__currentLoopData = $c->subspecifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                   ...
                   <div style="">
                    ...
                    <?php if($c->el_mc == 'mc'): ?>
                        ...
                        <p class="d-inline-block text-truncate" style="max-width: 400px;"> <?php echo e($c->name); ?>: 
                    ...
                    <?php if($c->name == 'Enclosure'): ?>
                        (<?php echo e($item->integral); ?>), <?php echo e($cdfd); ?> <?php echo e($item->fd_cd != ''?',':''); ?> (<?php echo e($item->gland); ?>)
                    <?php endif; ?>
                    <?php if(!empty($MName)): ?>
        ...
        <tr><td class="commTD"></td>
            ...
            <td colspan="2" style="font-weight: 600;" class="commTD">Electronic Testing</td>
         </tr>
        ...
        <tfoot class="abc2" >
            ...
            <td colspan="5" class="commTD"> 
                <div class=" tfoot-text">
                    ...
                    <p>Created by sales</p>
                    <p>Checked by concerned Department</p>
                </div>
                <div class=" tfoot-text">
                    <p>Prepared by</p>
                    <p>Department</p>
                    <p>Elecronics/Mechenical</p>
                </div>
            </td>
            </tr>
        </tfoot>
...
<?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/quotation/templates/template12.blade.php ENDPATH**/ ?>