...
<button type="button" style="padding:0.5rem 4rem 0.5rem 0.5rem;" class="btn bg-dark  text-white d-flex gap-2  pr-4 align-items-center">
    ...
    <div class="row">
        <?php echo e(Form::open(array('url' => 'order','class'=>'w-100'))); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group" style="margin-bottom: 0rem;">
                                    <?php echo e(Form::select('material_id',$product_services,'',array('class' => 'form-control select2 item','data-url'=>route('material.part'),'required'=>'required'))); ?>

                                </td>
                                 <td width="10%" class="form-group" style="margin-bottom: 0rem;">
                                   
                                        <?php echo e(Form::select('priority',$priority,null, array('class' => 'form-control select','required'=>'required'))); ?>
                        ...
                        <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <div class="form-group"><?php echo Form::textarea('note',null , ['class'=>'form-control pro_description','rows'=>'2','placeholder'=>__('Add Request Note')]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/orderrequest/create.blade.php ENDPATH**/ ?>