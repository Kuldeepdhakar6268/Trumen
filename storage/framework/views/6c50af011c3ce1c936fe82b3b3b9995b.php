                ...
                <div class="card-body">
                    <!-- <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="add_contact"><div class="row mx-2"><div class="col-md-2"><div class="form-group"><label for="prefix" class="form-label">Sr. No</label><input class="form-control" placeholder="01" name="prefix[]" type="text" id="prefix_name"></div></div><div class="col-md-4"><div class="form-group"><label for="sub_specification" class="form-label">Parts/Description</label><input class="form-control" placeholder="Handle" name="sub_specification[]" type="text" id="sub_specification"></div></div><div class="col-md-2"><div class="form-group"><label for="price" class="form-label">Unit Rate</label><input class="form-control" placeholder="10" name="price[]" type="text" id="price"></div></div><div class="col-md-2"><div class="form-group"><label for="price" class="form-label">Quantity</label><input class="form-control" placeholder="100" name="price[]" type="text" id="price"></div></div><div class="col-md-2"><div class="form-group"><label for="price" class="form-label">Net Value INR</label><input class="form-control" placeholder="1,000" name="price[]" type="text" id="price"></div></div></div></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/purchase/edit.blade.php ENDPATH**/ ?>