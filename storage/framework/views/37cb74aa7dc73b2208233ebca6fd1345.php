...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
                        ...
                        class="dash-item dash-hasmenu
                         ...
                         <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'account-dashboard' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('dashboard')); ?>" class="dash-link">
                                ...
                                <image src="<?php echo e(asset('assets/images/menu/dashboard.png')); ?>" width="20"></image>
                                </span>
                                <span
        ...
        <?php if(Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
            <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'production-dashboard' ? ' active dash-trigger' : ''); ?>">
            <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'production-dashboard' ? ' active dash-trigger' : ''); ?>">
                <a href="<?php echo e(route('production.dashboard')); ?>" class="dash-link ">
                    <span class="dash-micon">
                        <!-- <i class="ti ti-shopping-cart"></i> -->
                         <image src="<?php echo e(asset('assets/images/menu/Production.png')); ?>" width="20"></image>
                </span><span
       ...
       <?php if(!empty($userPlan) &&  $userPlan->project == 1): ?>
            <?php if(Gate::check('manage project')): ?>
                <li
                    class="dash-item dash-hasmenu
                                            <?php echo e(Request::segment(1) == 'manufacturing-dashboard' ||
                                            ...
                                            Request::segment(1) == 'project_report'
                                                ? 'active dash-trigger'
                                                : ''); ?>">
                    <a href="<?php echo e(route('manufacturing.dashboard')); ?>" class="dash-link"><span class="dash-micon">
                        <!-- <i class="ti ti-share"></i> -->
                        <image src="<?php echo e(asset('assets/images/menu/Manufacturing.png')); ?>" width="20"></image>

                    </span><span
                            class="dash-mtext"><?php echo e(__('Manufacturing')); ?></span><span class="dash-arrow">
            ...
            <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'notification_templates' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('disptch.dashboard')); ?>" class="dash-link">
                    <span class="dash-micon">
                        ...
                        <image src="<?php echo e(asset('assets/images/menu/Dispatch.png')); ?>" width="20"></image>
                ...
                <ul
                        class="dash-submenu">
                         ...
                         <li class="dash-item">
                            <a href="#"
                                class="dash-link"><?php echo e(__('Challan')); ?>

                            </a>
                        </li>
                         <li class="dash-item">
                            <a href="#"
                                class="dash-link"><?php echo e(__('Dispatch List')); ?>
       ...
       <?php if(\Auth::user()->type != 'super admin'): ?>
                ...
                <li
                    ...
                    <ul
                        ...
                        <li class="dash-item <?php echo e(Request::segment(1) == 'materialstock' ? 'active' : ''); ?>">
                         ...
                         <li class="dash-item <?php echo e(Request::segment(1) == 'deadproduct' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('deadproduct.index')); ?>"
                                class="dash-link"><?php echo e(__('Dead Product')); ?>

                            </a>
                        </li>
                         <li class="dash-item <?php echo e(Request::segment(1) == 'deadmaterial' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('deadmaterial.index')); ?>"
                                class="dash-link"><?php echo e(__('Dead Material')); ?>
                    ...
                    <li
                        class="dash-item dash-hasmenu
                                     ...
                                     Request::segment(1) == 'debit-note'
                                         ? ' active dash-trigger'
                                         : ''); ?>">
                        <a href="<?php echo e(route('finance.dashboard')); ?>" class="dash-link"><span class="dash-micon">
                            <!-- <i class="ti ti-box"></i> -->
                            <image src="<?php echo e(asset('assets/images/menu/Finance.png')); ?>" width="20"></image>
                        ...
                        <li
                            ...
                            <a href="<?php echo e(route('hrms.dashboard')); ?>" class="dash-link ">
                                <span class="dash-micon">
                                    ...
                                    <image src="<?php echo e(asset('assets/images/menu/Hrms.png')); ?>" width="20"></image>
        ...
        <?php if(!empty($userPlan) &&  $userPlan->project == 1): ?>
            <?php if(Gate::check('manage project')): ?>
                <li
                    class="dash-item dash-hasmenu
                                            <?php echo e(Request::segment(1) == 'reports-dashboard' ||
                                Request::segment(1) == 'income report' ||
                                ...
                                Request::segment(1) == 'reports-pos-vs-purchase'
                                    ? 'active dash-trigger'
                                    : ''); ?>">
                    <a href="<?php echo e(route('reports.dashboard')); ?>" class="dash-link"><span class="dash-micon">
                        <!-- <i class="ti ti-share"></i> -->
                        <image src="<?php echo e(asset('assets/images/menu/Reports.png')); ?>" width="20"></image>
                    ...
                    <ul class="dash-submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                            <li
                                ...
                                <a class="dash-link" href="<?php echo e(route('report.sales')); ?>"><?php echo e(__('Sales & CRM Reports')); ?></a>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task')): ?>
                            <li class="dash-item <?php echo e(request()->is('taskboard*') ? 'active' : ''); ?>">
                                <a class="dash-link"
                                    href="<?php echo e(route('report.production')); ?>"><?php echo e(__('Production Report')); ?></a>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage timesheet')): ?>
                            <li class="dash-item <?php echo e(request()->is('timesheet-list*') ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('report.purchase_management')); ?>"><?php echo e(__('Purchase & Management Report')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\Trumen\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>