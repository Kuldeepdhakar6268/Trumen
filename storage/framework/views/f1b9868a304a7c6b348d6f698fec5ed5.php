<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Order Request Edit')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><a href="<?php echo e(route('purchase.index')); ?>"><?php echo e(__('Order Request')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Order Request Edit')); ?></li>
<?php $__env->stopSection(); ?>
    ...
    <script>
        ...
        function changeItem(element) {
            ...
            $.ajax({
              ...
              $.ajax({
                        url: '<?php echo e(route('request.items')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php echo e(Form::model($purchase, array('route' => array('order.update', $purchase->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('created_date', __('Request Date'),['class'=>'form-label'])); ?>

                                        <?php echo e(Form::date('created_date',null,array('class'=>'form-control','required'=>'required'))); ?>

                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('purchase_number', __('Order Request Number'),['class'=>'form-label'])); ?>
        ...
        <div class="col-12">
            <h5 class="d-inline-block mb-4"><?php echo e(__('Order Request Details')); ?></h5>
            <div class="card repeater" data-value='<?php echo json_encode($Umaterial); ?>'>
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <div class="form-group">
                                        <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>route('material.part')))); ?>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("order.index")); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/orderrequest/edit.blade.php ENDPATH**/ ?>