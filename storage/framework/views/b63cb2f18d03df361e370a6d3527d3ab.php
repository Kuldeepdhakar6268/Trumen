...
<button type="button" style="padding:0.5rem 4rem 0.5rem 0.5rem;" class="btn bg-dark  text-white d-flex gap-2  pr-4 align-items-center">
    ...
    <div class="row">
        <?php echo e(Form::open(array('url' => 'orderReturn','class'=>'w-100'))); ?>
                   ...
                   <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                <?php echo e(Form::label('purchase_id', __('Search Po Number'),['class'=>'form-label'])); ?>

                                 <?php echo e(Form::select('purchase_id',$product_services,'',array('class' => 'form-control select2 item','data-url'=>route('purchase.return.item'),'required'=>'required'))); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('purchase_date', __('Search PO Date'),['class'=>'form-label'])); ?>
     ...
     <div class="row ">
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('name',null,array('class'=>'form-control','required'=>'required' , 'placeholder'=>__('M & S Gourav Gases')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('contact_person',null,array('class'=>'form-control','required'=>'required' , 'placeholder' => __('Mahi Sharma')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('area_name',null,array('class'=>'form-control' , 'required'=>'required', 'placeholder'=>__('Old Palasia')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('pincode',null,array('class'=>'form-control' , 'required'=>'required', 'placeholder'=>__('454720')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('city',null,array('class'=>'form-control' , 'required'=>'required', 'placeholder'=>__('Indore')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('state',null,array('class'=>'form-control' , 'required'=>'required', 'placeholder'=>__('Madhy Pradesh')))); ?>
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
             <div class="form-group">
                 ...
                 <?php echo e(Form::text('country',null,array('class'=>'form-control' , 'required'=>'required', 'placeholder'=>__('India')))); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-1">
                                     <?php echo e(Form::text('product_name','', array('class' => 'form-control product_name','placeholder'=>__('Product Name')))); ?>
    ...
    <div class="card px-3 py-3 my-3">
     ...
     <p class="my-3 fs-6 lh-lg text-secondary">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their
        ...
        <div>
         <svg style="cursor:pointer;" className=' cursor-pointer' width=<?php echo e("1.3rem"); ?> xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M14.8287 7.75737L9.1718 13.4142C8.78127 13.8047 8.78127 14.4379 9.1718 14.8284C9.56232 15.219 10.1955 15.219 10.586 14.8284L16.2429 9.17158C17.4144 8.00001 17.4144 6.10052 16.2429 4.92894C15.0713 3.75737 13.1718 3.75737 12.0002 4.92894L6.34337 10.5858C4.39075 12.5384 4.39075 15.7042 6.34337 17.6569C8.29599 19.6095 11.4618 19.6095 13.4144 17.6569L19.0713 12L20.4855 13.4142L14.8287 19.0711C12.095 21.8047 7.66283 21.8047 4.92916 19.0711C2.19549 16.3374 2.19549 11.9053 4.92916 9.17158L10.586 3.51473C12.5386 1.56211 15.7045 1.56211 17.6571 3.51473C19.6097 5.46735 19.6097 8.63317 17.6571 10.5858L12.0002 16.2427C10.8287 17.4142 8.92916 17.4142 7.75759 16.2427C6.58601 15.0711 6.58601 13.1716 7.75759 12L13.4144 6.34316L14.8287 7.75737Z"></path></svg>
         <svg style="cursor:pointer;" className='cursor-pointer' width=<?php echo e("1.3rem"); ?> xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M1.94619 9.31543C1.42365 9.14125 1.41953 8.86022 1.95694 8.68108L21.0431 2.31901C21.5716 2.14285 21.8747 2.43866 21.7266 2.95694L16.2734 22.0432C16.1224 22.5716 15.8178 22.59 15.5945 22.0876L12 14L18 6.00005L10 12L1.94619 9.31543Z"></path></svg>
         </div>
        </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/return_order/create.blade.php ENDPATH**/ ?>