        ...
        <?php if(!empty($userPlan) &&  $userPlan->pos == 1): ?>
            <?php if(Gate::check('manage warehouse') ||
                ...
                <li
                   ...
                   <a href="#!" class="dash-link d-flex"><span class="dash-micon"><i
                                class="ti ti-layers-difference"></i></span><span
...
<?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>