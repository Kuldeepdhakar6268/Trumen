                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::tel('phone', old('phone'), ['class' => 'form-control' , 'id'=>'phone','required' => 'required' ,'placeholder'=>'Enter employee phone'  ]); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::text('city', old('city'), ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee city name']); ?>

                                </div>
                                 <div class="form-group col-md-6">
                                    <?php echo Form::label('state', __('State'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('state', old('state'), ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee state name']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/employee/create.blade.php ENDPATH**/ ?>