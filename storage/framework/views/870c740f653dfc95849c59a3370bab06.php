                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Leads')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Interested')); ?> <br> <?php echo e(__('Leads')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Customer Pending Leads')); ?></h4>
                                        ...
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <div class="mt-2">
                                               ...
                                               <?php echo e($lastMonth_pendingOrder); ?> call Pending
                                            </div>
                                              ...
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#2EAF2B;"></span>
                                                ...
                                                <?php echo e($lastMonth_completeOrder); ?> call Completed
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Converted Customer')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Customer Area Pending Payment')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> Pending Payment</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Total Leads</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/sales&crm-dashboard.blade.php ENDPATH**/ ?>