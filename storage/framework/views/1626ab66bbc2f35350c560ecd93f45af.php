...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('leads.create')); ?>" title="<?php echo e(__('Create New Lead')); ?>" data-title="<?php echo e(__('Create Lead')); ?>" class="btn btn-sm btn-primary">
                                                    ...
                                                    <div class="btn-group card-option">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit lead')): ?>
                                                                ...
                                                                <a href="<?php echo e(URL::to('leads/'.$lead->id.'/edit')); ?>" class="dropdown-item" data-bs-original-title="<?php echo e(__('Edit Lead')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/leads/index.blade.php ENDPATH**/ ?>