                                    ...
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-INR-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/sale-icon.png')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Employee')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-customer-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/customer-icon.png')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('New')); ?> <br> <?php echo e(__('Employee')); ?></p>
                                    ...
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-order-accountdashboard">
                                                   <img src="<?php echo e(asset('assets/images/dashboard/order-icon.png')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Department')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Designation')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Login Report')); ?></h4>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <div class="mt-2">
                                                <img src="<?php echo e(asset('assets/images/dashboard/sandclock.png')); ?>" alt="">
                                               <?php echo e($lastMonth_pendingOrder); ?> Leaves
                                            </div>
                                              <div class="mt-2">
                                                <img src="<?php echo e(asset('assets/images/dashboard/ongoing.png')); ?>" alt="">
                                                <?php echo e($lastMonth_ongoingOrder); ?> On-Break
                                            </div>
                                              <div class="mt-2">
                                                <img src="<?php echo e(asset('assets/images/dashboard/completed.png')); ?>" alt="">
                                                <?php echo e($lastMonth_completeOrder); ?> Online
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    <div class="image-container">
                                        ...
                                        <div class="centered-text">
                                            ...
                                            <h3 style="font-size: 15px;font-weight: normal;">Employee Active</h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Employee Feedback')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                                            ...
                                            <div class="position-relative">
                                                <div class="image-container">
                                                    <img src="<?php echo e(asset('assets/images/dashboard/dispatch-img.png')); ?>" alt="" class="img-fluid">
                                                    <div class="centered-text" style="left: 36%;">
                                                        <h3><?php echo e(($lastMonth_pendingOrder/$totalManOrder) * 100); ?>%</h3>
                                                        
                                                    </div><span style="float: right;margin-top: 76px;"><div class="btn btn-primary"><?php echo e(($lastMonth_pendingOrder/$totalManOrder) * 100); ?>%</div></span>
                                                    <div class="text-right-overlay" style="text-align: justify;">
                                                                <span style='color:#FF5000'><i class='bx bxs-circle' style='color:#FF5000'></i>Pending Order <?php echo e((($lastMonth_pendingOrder/$totalManOrder) * 100)); ?></span>  
                                                                <span style="color: blue;"><i class='bx bxs-circle' style="color: blue;"></i> Complete Order <?php echo e((($lastMonth_pendingOrder/$totalManOrder) * 100)); ?></span>
                                                    </div>
                                               </div>
                                            </div>
...
<div class="col-md-4" >
    <div class="card"style="height:516px;"  >
        <div class="card-header">
           <div class="d-flex justify-content-between">
                  <h4 class="mt-1 mb-0"><?php echo e(__('Open Positions')); ?></h4>
        ...
        <div class="card-body m-0 p-0">
           <table>
            ...
            <tr>
                ...
                <img src="<?php echo e(asset('assets/images/dashboard/position-status-complete.svg')); ?>" alt="" style="height: 20px;">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="d-flex justify-content-center">
                <img src="<?php echo e(asset('assets/images/dashboard/position-status-pending.svg')); ?>" alt="" style="height: 20px;">
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Department Performance')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> This month</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Last month</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/hrms-dashboard.blade.php ENDPATH**/ ?>