            ...
            <div class="card emp_details">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo Form::label('phone_number', __('Phone'),['class'=>'form-label']); ?><span class="text-danger pl-1">*</span>
                            <?php echo Form::hidden('phone',null, ['class' => 'form-control', 'id'=> 'phone_number']); ?>

                            <?php echo Form::tel('tel',$employee->phone, ['class' => 'form-control', 'id' => 'phone']); ?>
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::password('password',['class' => 'form-control', 'placeholder'=>'Enter employee new password']); ?>

                                </div>
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('city', __('City'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('city',$employee->user->city, ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee city name']); ?>

                                </div>
                                 <div class="form-group col-md-6">
                                    <?php echo Form::label('state', __('State'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('state',$employee->user->state, ['class' => 'form-control', 'required' => 'required' ,'placeholder'=>'Enter employee state name']); ?>

                                </div>
                                 
                          <div class="form-group col-md-6">
                                <?php echo e(Form::label('role', __('Employee Role'), ['class' => 'form-label'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/employee/edit.blade.php ENDPATH**/ ?>