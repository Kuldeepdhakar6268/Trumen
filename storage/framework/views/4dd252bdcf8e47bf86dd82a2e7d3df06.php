...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
         ...
         <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                <input type="hidden" value="<?php echo e($customer->lead_id); ?>" name="lead_id">
                <?php echo e(Form::label('industry_name',__('Company Name'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('industry_name',$indutry,array('class'=>'form-control'))); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <select class="form-control select" id="status" name="status">
                    <option value="Pending" <?php echo e($customer->status == 'Pending'?'selected':''); ?>>Pending</option>
                    <option value="Confirm" <?php echo e($customer->status == 'Confirm'?'selected':''); ?>>Confirm</option>
                    <option value="Cancel" <?php echo e($customer->status == 'Cancel'?'selected':''); ?>>Cancel</option>
                    </select>
            </div>
        </div>
...
<?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/customer/edit.blade.php ENDPATH**/ ?>