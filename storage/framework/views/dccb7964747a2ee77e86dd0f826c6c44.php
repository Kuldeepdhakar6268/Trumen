                                ...
                                <tr>
                                    <td class="Id">
                                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show employee profile')): ?>
                                            <a href="<?php echo e(route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>" class="text-light bg-primary" style="padding: 13px 23px 13px 26px;border-radius: 20px 0px 0px 17px;margin-left: -18px;"><?php echo e($loop->iteration); ?></a>
                                        <?php else: ?>
                                            <a href="#"  class="text-light"><?php echo e(\Auth::user()->employeeIdFormat($employee->employee_id)); ?></a>
                                        <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                     <td>
                                        <?php echo e(\Carbon\Carbon::parse($employee->user->created_at)->format('d M Y, g:i A D')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/employee/index.blade.php ENDPATH**/ ?>