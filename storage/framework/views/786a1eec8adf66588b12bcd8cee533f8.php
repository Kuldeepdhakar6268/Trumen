                                    ...
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-INR-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/customer-icon.svg')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Customer')); ?> <br> <?php echo e(__('')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar rounded-circle bg-customer-accountdashboard">
                                                  <img src="<?php echo e(asset('assets/images/dashboard/vendor-icon.svg')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Vendor')); ?> <br> <?php echo e(__('')); ?></p>
                                    ...
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-order-accountdashboard">
                                                   <img src="<?php echo e(asset('assets/images/dashboard/bank-icon.svg')); ?>" alt="" style="height: 50px;">
                                            </div>
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Bank')); ?> <br> <?php echo e(__('')); ?></p>
                                    ...
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            <div class="theme-avtar bg-invoice-accountdashboard">
                                                    <img src="<?php echo e(asset('assets/images/dashboard/cash-icon.svg')); ?>" alt="" style="height: 50px;">
                                            </div>
                                             <h3 class="mb-0 mt-3"><?php echo e(\Auth::user()->countInvoices()); ?> </h3>
                                                                                         <span class="percent-heading">0.5% </br>from yesterday</span>

                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Cash')); ?> <br> <?php echo e(__('')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Miscellaneous Operation')); ?></h4>
                                        ...
                                        <div class="col-6">
                                            <div class="mt-2">
                                              ...
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#DF7C7C;"></span>
                                               ...
                                               <?php echo e($lastMonth_pendingOrder); ?> Entry Pending
                                            </div>
                                            
                                              <div class="mt-2">
                                              <span class="h-1 w-1  m-1 px-2 rounded-circle " style="background:#2EAF2B;"></span>

                                                <?php echo e($lastMonth_completeOrder); ?> Entry Completed
                                            </div>
                                            </div>
                                        </div>
                                 <div class="col-6">
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Salaries')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Transaction')); ?></h4>
                                    <div class="view-button-accountdashboard">
                                      <span><i class='bx bxs-circle' style='color:#FF5000'  ></i> Bank</span>  
                                      <span><i class='bx bxs-circle' style="color: #00E096;"></i> Cash</span>  
                                    </div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\_trumen\resources\views/dashboard/finance-dashboard.blade.php ENDPATH**/ ?>