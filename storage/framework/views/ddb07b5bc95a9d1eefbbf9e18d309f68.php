...
<?php endif; ?>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card INR-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Sales')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card customer-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Customers')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card order-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Order')); ?></p>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card invoice-card-accountdashboard">
                                        <div class="card-body">
                                            ...
                                            <p class="text-lg mt-4 mb-2 font-weight-600"><?php echo e(__('Total')); ?> <br> <?php echo e(__('Invoicing')); ?></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="height:400px;">
                                <div class="card-header">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Pending order for Manufacturing')); ?></h4>
                                    ...
                                    <div class="card" style="height: 516px;">
                                        <div class="card-header">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Pending Order For Dispatch')); ?></h4>
                                                    <p class="mt-2">Last 1 Months</p>
                                                </div>
    ...
    <div class="card" style="height: 516px;">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div>
                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Dead Stock')); ?></h4>
                      <p class="mt-2">Last 1 Months</p>
                </div>
                    ...
                    <div class="row">
                         <div class="col-xxl-5">
                            <div class="card" style="height: 572px;">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                    <h4 class="mt-1 mb-0"><?php echo e(__('Total Pending Payment')); ?></h4>
                                    <div class="view-button-accountdashboard">
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-body" style="height:545px;padding: 0;">
                        ...
                        <div class="col-4">
                            <div class="card">
                                <div class="card-body task-calendar-scroll" style="height:615px;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>