...
<body class="<?php echo e($themeColor); ?>">
    <div class="custom-login-form-new ">
        ...
        <div class="custom-login-form-new-img bg-primary">
            ...
            <div>
                <img src="<?php echo e(asset('assets/images/auth/lines.png')); ?>" class="login-bg-img-1">
            </div>
        </div>
        <div class="hello-trumen-text-org">
            <h1>
                Hello <br> <?php echo e(Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'ERPGO')); ?>!
            </h1>
        </div>
...
<?php /**PATH /home/u217475692/domains/truelymatch.com/public_html/trumen/resources/views/layouts/auth.blade.php ENDPATH**/ ?>